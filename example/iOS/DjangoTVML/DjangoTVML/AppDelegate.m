...
static NSString *tvBaseURL = @"http://127.0.0.1:8000/";
static NSString *tvRootURL = @"http://127.0.0.1:8000/appletv/";
static NSString *tvBootURL = @"http://127.0.0.1:8000/static/js/application.js";
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    NSMutableDictionary *appControllerOptions = appControllerContext.launchOptions ? [appControllerContext.launchOptions mutableCopy] : [@{} mutableCopy];
    appControllerOptions[@"baseURL"] = tvBaseURL;
    appControllerOptions[@"startDocURL"] = tvRootURL;
